...
/*PennController.Sequence( "final", "practice_trials", "critical_trials", "fillers", randomize("post_task2"),randomize("post_task2"), "instructions1","instructions2", "preloadCritical","critical_trials", "fillers", rshuffle(pick(critical,8),pick(fillers,10)),"break",
                           rshuffle(pick(critical,8),pick(fillers,10)),"break", 
                           rshuffle(pick(critical,8),pick(fillers,10)),"break"
                          );
...
PennController.Template( PennController.GetTable("practice.csv") // use subset.csv for celebrity names
                         ...
                         variable => ["practice_trials",
                                      "PennController", PennController(
                                          ...
                                          .remove()
                                          ,
                                          newCanvas("crit_instructions", 600, 50)
                                          .center()
                                      ...
                                      .size(50,50)
                                      ,
                                      newCanvas("bio_instructions", 800, 150)
                                      .center()
                                      ,
                                      newCanvas("bio_instructions2", 800, 40)
                                      .center()
                                      ,
                                      ...
                                      (variable.comp_q=="skip" ? [
                                       ...
                                       getCanvas("bio_instructions", 800, 150)
                                      .center()
                                      .add("center at 50%",0,newText ("ex_ctit_task", "Ist der Satz in Bezug  auf die Worte der gezeigten Pers&ouml;nlichkeit wahr? <p>")
                                           .settings.center()
                                           .settings.css("font-size", "20px")
                                           .settings.color("red"))
                                      //.css( "border" , "solid 1px black" )
                                      .print()
                                      ,
                                      getText("comp_q_practice" , variable.comp_q)
                                      .center()
                                      .print()
                                      ,
                                      getCanvas("bio_instructions2", 800, 40)
                                      .center()
                                      // F-Version:
                                      .add("center at 50%",0,newText ("ex_ctit_task2", "<p><br><b>links = 'Ja' / rechts = 'Nein'</b><p>")
                                           //J-Version:
                                           //.add("center at 50%",0,newText ("ex_ctit_task2", "<p><br><b>links = 'Nein' / rechts = 'Ja'</b><p>")  
                                           .settings.css("font-size", "20px")
                                           .settings.center()
                                           .settings.color("red"))
                                      //.css( "border" , "solid 1px black" )
...
PennController.Template( PennController.GetTable("master_stimuli_spr12_CQ.csv") // use subset.csv for celebrity names
                         ...
                         variable => ["fillers",
                                      "PennController", PennController(
                                          ...
                                          .print()
                                          ,
                                          newCanvas("pic_filler_c", 800,380)
                                      ...
                                      (variable.comp_q=="skip" ? [
                                       ...
                                       getText("comp_q_f" , variable.comp_q)
                                      .print("center at 50%","middle at 30%")
                                      ,
                                      getCanvas("yes_no5")
                                      // F-Version:
